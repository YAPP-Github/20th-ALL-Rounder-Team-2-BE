...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "클래스-info 읽기 모델", description = "클래스-info 읽기 전용 모델")
public class LectureInformationDtoReadOnly {
    @ApiModelProperty(
            value = "클래스-info id",
