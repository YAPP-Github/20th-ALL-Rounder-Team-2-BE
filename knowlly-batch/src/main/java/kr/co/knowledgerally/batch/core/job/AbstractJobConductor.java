...
import kr.co.knowledgerally.batch.util.JobLauncherUtil;
 ...
 *
 * @see kr.co.knowledgerally.batch.core.config.AutowiringSpringBeanJobFactory
 */
@Slf4j
public abstract class AbstractJobConductor extends KnowllyQuartzJob
        implements JobRequestService, KnowllyJobLauncherProvider {
    @Autowired
    ...
    @Override
    public KnowllyJobLauncher getLauncher() {
        return new KnowllyJobLauncher(getJob(), jobLauncher);
    }
